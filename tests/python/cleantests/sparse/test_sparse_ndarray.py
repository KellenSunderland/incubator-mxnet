...
class TestSparseNDArray:
    ...
    @attr('cpu')
    def test_sparse_nd_setitem(self):
    ...
    @attr('cpu')
    def test_sparse_nd_equal(self):
        for stype in ['row_sparse', 'csr']:
            shape = rand_shape_2d()
            x = mx.nd.zeros(shape=shape, stype=stype)
            y = self.sparse_nd_ones(shape, stype)
            z = x == y
    ...
    @attr('cpu')
    def test_sparse_nd_not_equal(self):
        for stype in ['row_sparse', 'csr']:
            shape = rand_shape_2d()
            x = mx.nd.zeros(shape=shape, stype=stype)
            y = self.sparse_nd_ones(shape, stype)
    ...
    @attr('cpu')
    def test_sparse_nd_greater(self):
        for stype in ['row_sparse', 'csr']:
            shape = rand_shape_2d()
            x = mx.nd.zeros(shape=shape, stype=stype)
            y = self.sparse_nd_ones(shape, stype)
    ...
    @attr('cpu')
    def test_sparse_nd_greater_equal(self):
        for stype in ['row_sparse', 'csr']:
            shape = rand_shape_2d()
            x = mx.nd.zeros(shape=shape, stype=stype)
            y = self.sparse_nd_ones(shape, stype)
    ...
    @attr('cpu')
    def test_sparse_nd_lesser(self):
        for stype in ['row_sparse', 'csr']:
            shape = rand_shape_2d()
            x = mx.nd.zeros(shape=shape, stype=stype)
            y = self.sparse_nd_ones(shape, stype)
    ...
    @attr('cpu')
    def test_sparse_nd_lesser_equal(self):
        for stype in ['row_sparse', 'csr']:
            shape = rand_shape_2d()
            x = mx.nd.zeros(shape=shape, stype=stype)
            y = self.sparse_nd_ones(shape, stype)
    ...
    @attr('cpu')
    def test_sparse_nd_binary(self):
        N = 3
    ...
    @attr('cpu')
    def test_sparse_nd_binary_scalar_op(self):
        N = 3
    ...
    @attr('cpu')
    def test_sparse_nd_binary_iop(self):
        N = 3
    ...
    @attr('cpu')
    def test_sparse_nd_negate(self):
    ...
    @attr('cpu')
    def test_sparse_nd_broadcast(self):
        sample_num = 1000
    ...
    @attr('cpu')
    def test_sparse_nd_transpose(self):
        npy = np.random.uniform(-10, 10, rand_shape_2d())
        stypes = ['csr', 'row_sparse']
        for stype in stypes:
            nd = mx.nd.array(npy).tostype(stype)
    ...
    @attr('cpu')
    def test_sparse_nd_storage_fallback(self):
    ...
    @attr('cpu')
    def test_sparse_nd_random(self):
    ...
    @attr('cpu')
    def test_sparse_nd_astype(self):
        stypes = ['row_sparse', 'csr']
        for stype in stypes:
    ...
    @attr('cpu')
    def test_sparse_nd_pickle(self):
        np.random.seed(0)
        repeat = 1
        dim0 = 40
        dim1 = 40
    ...
    # TODO(kellens) try catch
    @attr('cpu')
    def test_sparse_nd_save_load(self):
        np.random.seed(0)
        repeat = 1
    ...
    # TODO(kellens) expect error
    @attr('cpu')
    def test_sparse_nd_unsupported(self):
    ...
    @attr('gpu')
    @attr('cpu')
    def test_create_row_sparse(self):
        dim0 = 50
        dim1 = 50
        densities = [0, 0.5, 1]
        for density in densities:
    ...
    @attr('cpu')
    @attr('gpu')
    def test_create_sparse_nd_infer_shape(self):
    ...
    @attr('cpu')
    @attr('gpu')
    def test_create_sparse_nd_from_dense(self):
    ...
    @attr('cpu')
    @attr('gpu')
    def test_create_sparse_nd_from_sparse(self):
    ...
    @attr('cpu')
    @attr('gpu')
    def test_create_sparse_nd_empty(self):
    ...
    def test_synthetic_dataset_generator(self):
        def check_powerlaw_generator(csr_arr, final_row=1):
        ...
        check_powerlaw_generator(csr_arr_cols, final_row=9)
        check_powerlaw_generator(csr_arr_small, final_row=1)
        check_powerlaw_generator(csr_arr_big, final_row=4)
        check_powerlaw_generator(csr_arr_square, final_row=6)

    @attr('cpu')
    def test_sparse_nd_fluent(self):
    ...
    @attr('cpu')
    def test_sparse_nd_exception(self):
    ...
    @attr('cpu')
    @attr('gpu')
    def test_sparse_nd_check_format(self):
