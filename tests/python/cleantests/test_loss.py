...
class TestLoss:
    ...
    def get_net(self, num_hidden, flatten=True):
    ...
    def test_kl_loss(self):
        ...
        data_iter = mx.io.NDArrayIter(data, label, batch_size=10, label_name='label')
        output = mx.sym.log_softmax(self.get_net(2))
        l = mx.symbol.Variable('label')
