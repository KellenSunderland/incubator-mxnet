...
class TestIO:
    ...
    def test_NDArrayIter_h5py(self):
        if not h5py:
            return
    ...
    @unittest.skip(
        "test fails intermittently. temporarily disabled till it gets fixed. tracked at https://github.com/apache/incubator-mxnet/issues/7826")
    def test_CSVIter(self):
