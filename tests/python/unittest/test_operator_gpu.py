...
class TestOperatorGpu:
    ...
    def test_countsketch(self):
        ...
        for repeat in range(nrepeat):
            ...
            TestOperatorGpu.check_countsketch(in_dim, out_dim, n)
    ...
    def test_ifft(self):
        ...
        for repeat in range(nrepeat):
            for order in [2, 4]:
                ...
                TestOperatorGpu.check_ifft(shape)
    ...
    def test_fft(self):
        ...
        for repeat in range(nrepeat):
            for order in [2, 4]:
                shape = tuple(np.random.randint(1, maxdim, size=order))
                TestOperatorGpu.check_fft(shape)

    @attr('gpu')
    def test_batchnorm_with_type(self):
        ctx_list_v1_2D = [
    ...
    @attr('gpu')
    def test_batchnorm_versions(self):
    ...
    @attr('gpu')
    def test_convolution_with_type(self):
        np.random.seed(1234)
        ...
        check_consistency(sym, ctx_list, grad_req={'conv_data': 'write', 'conv_weight': 'write', 'conv_bias': 'null'},
                          tol=tol)
    ...
    def test_convolution_options(self):
        ...
        TestOperatorGpu.check_consistency_NxM([sym, sym_no_cudnn], ctx_list)
        # Stride > 1
    ...
    @attr('gpu')
    def test_convolution_versions(self):
        # 2D convolution NCHW
    ...
    @attr('gpu')
    def test_pooling_with_type(self):
    ...
    @attr('gpu')
    def test_deconvolution_with_type(self):
    ...
    @attr('gpu')
    def test_deconvolution_options(self):
    ...
    #    check_consistency_NxM([sym, sym_no_cudnn], ctx_list)
    @attr('gpu')
    def test_bilinear_sampler_with_type(self):
        np.random.seed(1234)
    ...
    @attr('gpu')
    def test_grid_generator_with_type(self):
        data = mx.sym.Variable('data')
    ...
    @unittest.skip(
        "test fails intermittently. temporarily disabled till it gets fixed. tracked at https://github.com/apache/incubator-mxnet/issues/7645")
    @attr('gpu')
    def test_spatial_transformer_with_type(self):
        np.random.seed(1234)
        data = mx.sym.Variable('data')
    ...
    @attr('gpu')
    def test_upsampling_with_type(self):
    ...
    @attr('gpu')
    def test_upsampling_bilinear_with_type(self):
    ...
    @attr('gpu')
    def test_concat_with_type(self):
    ...
    @attr('gpu')
    def test_elementwisesum_with_type(self):
    ...
    @attr('gpu')
    def test_reshape_with_type(self):
    ...
    @attr('gpu')
    def test_blockgrad_with_type(self):
    ...
    @attr('gpu')
    def test_swapaxis_with_type(self):
    ...
    @attr('gpu')
    def test_fullyconnected_with_type(self):
    ...
    @attr('gpu')
    def test_activation_with_type(self):
    ...
    @attr('gpu')
    def test_embedding_with_type(self):
    ...
    @attr('gpu')
    def test_svmoutput_with_type(self):
    ...
    def check_rnn_consistency(self, cell1, cell2):
        dshape = (32, 5, 200)
        data = mx.sym.Variable('data')
    ...
    def test_rnn(self):
        ...
        TestOperatorGpu.check_rnn_consistency(fused, stack)
        TestOperatorGpu.check_rnn_consistency(stack, fused)
    ...
    @attr('gpu')
    def test_psroipooling_with_type(self):
        np.random.seed(1234)
        arg_params = {
    ...
    @attr('gpu')
    def test_deformable_psroipooling_with_type(self):
        np.random.seed(1234)
        arg_params = {
            'deformable_psroipool_rois': np.array([[0, 10, 22, 161, 173], [0, 20, 15, 154, 160]])}

        # deformable psroipooling
        sym = mx.sym.contrib.DeformablePSROIPooling(spatial_scale=0.0625, sample_per_part=4, group_size=3,
                                                    pooled_size=3,
                                                    output_dim=2, trans_std=0.1, no_trans=False,
                                                    name='deformable_psroipool')
    ...
    @attr('gpu')
    def test_deformable_convolution_with_type(self):
        np.random.seed(1234)
    ...
    @attr('gpu')
    def test_deformable_convolution_options(self):
        # 2D convolution
    ...
    @unittest.skip(
        "Test fails intermittently. Temporarily disabled until fixed. Tracked at https://github.com/apache/incubator-mxnet/issues/8564")
    @attr('gpu')
    def test_residual_fused(self):
    ...
    def test_rnn_layer(self):
        TestOperatorGpu.check_rnn_layer(gluon.rnn.RNN(100, num_layers=3))
        TestOperatorGpu.check_rnn_layer(gluon.rnn.RNN(100, activation='tanh', num_layers=3))
        TestOperatorGpu.check_rnn_layer(gluon.rnn.LSTM(100, num_layers=3))
        TestOperatorGpu.check_rnn_layer(gluon.rnn.GRU(100, num_layers=3))

        TestOperatorGpu.check_rnn_layer(gluon.rnn.LSTM(100, num_layers=3, bidirectional=True))

    @attr('gpu')
    def test_sequence_reverse(self):
        TestOperatorGpu.check_sequence_reverse(mx.gpu(0))

    @unittest.skip(
        "Test fails intermittently. Temporarily disabled until fixed. Tracked at https://github.com/apache/incubator-mxnet/issues/8211")
    @attr('gpu')
    def test_autograd_save_memory(self):
        x = mx.nd.zeros((128, 512, 512), ctx=mx.gpu(0))
        x.attach_grad()

        with mx.autograd.record(self):
            for i in range(200):
                x = x + 1
                x.wait_to_read()
        x.backward()
    ...
    @attr('gpu')
    def test_gluon_ctc_consistency(self):
    ...
    @attr('gpu')
    def test_global_norm_clip_multi_device(self):
