...
class TestGluon:
    ...
    # TODO(kellens) make these tests paramaterized.
    @attr('nightly')
    @attr('cpu')
...
# TODO(kellens): Make this threadsafe.
class TestGluonDataFromNetwork:

    # TODO(kellens): Correct setup attr
    def __init__(self):
        self._rec = 'data/test.rec'
    ...
    @attr('cpu')
    def test_recordimage_dataset(self):
        dataset = gluon.data.vision.ImageRecordDataset(self._rec)
