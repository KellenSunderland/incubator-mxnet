...
# TODO(kellens): Is there some reason we're not testing gpu here?
class TestGluonContrib:
    ...
    def test_rnn_cells(self):
        self.check_rnn_forward(contrib.rnn.Conv1DLSTMCell((5, 7), 10, (3,), (3,)),
                               mx.nd.ones((8, 3, 5, 7)))
        self.check_rnn_forward(contrib.rnn.Conv1DRNNCell((5, 7), 10, (3,), (3,)),
                               mx.nd.ones((8, 3, 5, 7)))
        self.check_rnn_forward(contrib.rnn.Conv1DGRUCell((5, 7), 10, (3,), (3,)),
                               mx.nd.ones((8, 3, 5, 7)))
        ...
        self.check_rnn_forward(net, mx.nd.ones((8, 3, 5, 7)))

    @attr('cpu')
    def test_convrnn(self):
        cell = contrib.rnn.Conv1DRNNCell((10, 50), 100, 3, 3, prefix='rnn_')
        self.check_rnn_cell(cell, prefix='rnn_', in_shape=(1, 10, 50), out_shape=(1, 100, 48))

        cell = contrib.rnn.Conv2DRNNCell((10, 20, 50), 100, 3, 3, prefix='rnn_')
        self.check_rnn_cell(cell, prefix='rnn_', in_shape=(1, 10, 20, 50), out_shape=(1, 100, 18, 48))

        cell = contrib.rnn.Conv3DRNNCell((10, 20, 30, 50), 100, 3, 3, prefix='rnn_')
        self.check_rnn_cell(cell, prefix='rnn_', in_shape=(1, 10, 20, 30, 50), out_shape=(1, 100, 18, 28, 48))
