...
class TestGluon:
    ...
    def test_conv(self):
        ...
        for layer in layers1d:
            self.check_layer_forward(layer, (1, 4, 10))
        ...
        for layer in layers2d:
            self.check_layer_forward(layer, (1, 4, 20, 20))
        ...
        for layer in layers3d:
            self.check_layer_forward(layer, (1, 4, 10, 10, 10))

        # TODO(kellens) why is this commented out?
    ...
    def test_deconv(self):
        # TODO(kellens): Decide if this is still required.
        # layers1d = [
    ...
    def test_pool(self):
        ...
        for layer in layers1d:
            self.check_layer_forward(layer, (1, 2, 10))
        ...
        for layer in layers2d:
            self.check_layer_forward(layer, (1, 2, 10, 10))
        ...
        for layer in layers3d:
            self.check_layer_forward(layer, (1, 2, 10, 10, 10))
    ...
    def test_batchnorm(self):
        ...
        self.check_layer_forward(layer, (2, 10, 10, 10))
    ...
    def test_split_data(self):
        ...
        self.check_split_data(x, 8, 0)
        self.check_split_data(x, 3, 1)
        self.check_split_data(x, 4, 1, even_split=False)
        self.check_split_data(x, 15, 1, even_split=False)

        # TODO(kellens) proper exception expcetation
        try:
            self.check_split_data(x, 4, 1)
        except ValueError:
            return
    ...
    def test_trainer(self):
        def dict_equ(a, b):
            assert set(a) == set(b)
            for k in a:
                # TODO(kellens) what does this all do?
    ...
    @attr('cpu')
    @attr('gpu')
    def test_block_attr_hidden(self):
        b = gluon.Block()
    ...
    @attr('gpu')
    @raises(TypeError)
    def test_block_attr_block(self):
        b = gluon.Block()
    ...
    @attr('gpu')
    @raises(TypeError)
    def test_block_attr_param(self):
        b = gluon.Block()

        # regular variables can't change types
        b.b = gluon.Parameter('TestParam')
        b.b = (2,)

    @attr('cpu')
    @attr('gpu')
    def test_block_attr_regular(self):
        b = gluon.Block()
    ...
    @attr('cpu')
    @attr('gpu')
    def test_hybrid_stale_cache(self):
    ...
    @attr('cpu')
    @attr('gpu')
    def test_fill_shape_deferred(self):
