...
class TestAttr:
    ...
    def test_list_attr(self):
        ...
        assert TestAttr.contain({'__mood__': 'so so', 'wd_mult': 'x', '__wd_mult__': 'x'}, op.list_attr())
